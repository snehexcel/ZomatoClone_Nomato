    ...
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.sec1}>
                <div className={footerCss.logoBox}>Nomato</div>
            ...
            <div className={footerCss.sec2}>
                <div className={[footerCss.box1, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>ABOUT NOMATO</div>
                ...
                <div className={[footerCss.box2, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>NOMAVERSE</div>
                    <a href="" className={footerCss.boxOpt}>Nomato</a>
                    <a href="" className={footerCss.boxOpt}>Feeding India</a>
                    <a href="" className={footerCss.boxOpt}>Hyperpure</a>
                    <a href="" className={footerCss.boxOpt}>Nomaland</a>
                </div>
                <div className={[footerCss.box3, footerCss.box].join(' ')}>
                    ...
                    <a href="" className={footerCss.boxOpt}>Nomato For Work</a>
                </div>
            ...
            <div className={footerCss.sec3}>
                By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2024 © Nomato™ Ltd. All rights reserved.
            </div>
        </div>
    </div>
}
