...
let ExploreOptionsNearMe = () => {
    let chain = ['del', 'southdelhi', 'Hauzkhas', 'Del', 'southdelhi', 'Hauzkhas', 'Saket', 'southdelhi', 'Hauzkhas', 'Saket', 'southdelhi', 'Hauzkhas', 'Saket', 'southdelhi', 'Hauzkhas', 'Saket', 'southdelhi', 'Hauzkhas', 'Saket', 'southdelhi', 'Hauzkhas', 'Saket', 'southdelhi', 'Hauzkhas', 'Saket', 'southdelhi', 'Hauzkhas']
